...
{
    // Validación básica
    $campos = ['nombre', 'apellido', 'nombre_usuario', 'telefono', 'email', 'password', 'confirmPassword', 'direccion'];
    ...
    try {
        $mongoClient = new MongoDB\Client("mongodb://grupo6:grupo6@localhost:27017");
        ...
        $_SESSION['error_message'] = "Error al conectar con la base de datos MongoDB.";
        return false;
    }
}
    ...
    <div class="modal-content">
        ...
        <div class="container mt-2">
            <form action="#" method="post" id="registro-form">
                ...
                <input type="hidden" name="registro" value="true"> <!-- Campo oculto para identificar el envío de registro -->
        ...
        <?php if (isset($_GET['registro']) && $_GET['registro'] === 'exitoso'): ?>
            <p class="text-success">¡Registro exitoso! Bienvenido a AgroCultura.</p>
        <?php elseif (isset($_GET['registro']) && $_GET['registro'] === 'error'): ?>
            <p class="text-danger">Hubo un problema al registrar el usuario. Por favor, inténtelo nuevamente.</p>
        <?php endif; ?>
    </div>
</div>
